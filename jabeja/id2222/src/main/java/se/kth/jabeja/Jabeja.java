...
*/
    ...
    private void sampleAndSwap(int nodeId) {
        ...
        if (partner != null) {
            numberOfSwaps++;
            int partnerOldColor = partner.getColor();
            partner.setColor(nodep.getColor());
            nodep.setColor(partnerOldColor);
        }
    }
...
/*
  ...
  */
    ...
    private double acceptanceProbability(double oldCost, double newCost) {
        //new-old because it is not actually cost, rather a score, higher is better.
